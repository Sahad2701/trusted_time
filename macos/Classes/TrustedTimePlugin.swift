...
/**
 * TrustedTimePlugin - Native macOS implementation for TrustedTime.
 *
 * This plugin provides the hardware-backed monotonic clock reference needed 
 * to defy system wall-clock manipulation. On macOS, we leverage `ProcessInfo.systemUptime`
...
public class TrustedTimePlugin: NSObject, FlutterPlugin {
     ...
     *
     * Supported methods:
     * - getPlatformVersion: Returns macOS version string
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "getUptimeMs":
            // systemUptime is the most reliable monotonic clock on macOS.
